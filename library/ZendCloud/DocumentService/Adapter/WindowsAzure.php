...
use ZendService\WindowsAzure\Storage\DynamicTableEntity;
...
class WindowsAzure extends AbstractAdapter
{
    ...
    const DEFAULT_QUERY_CLASS   = '\ZendCloud\DocumentService\Adapter\WindowsAzure\Query';

    /**
     * Azure  service instance.
     *
     * @var \ZendService\WindowsAzure\Storage\Table
     */
     ...
     * @var string
     */
    protected $_queryClass = '\ZendCloud\DocumentService\Adapter\WindowsAzure\Query';
    ...
    public function __construct($options = array())
    {
        ...
        try {
            $this->_storageClient = new \ZendService\WindowsAzure\Storage\Table(
     ...
     *
     * @param  string $key
     * @return \ZendCloud\DocumentService\Adapter\WindowsAzure
     */
    ...
    {
        if ($documentId instanceof \ZendCloud\DocumentService\Document) {
            $documentId = $documentId->getId();
        }
     ...
     *
     * @return \ZendService\WindowsAzure\Storage\Table
     */
     ...
     *
     * @param  \ZendService\WindowsAzure\Storage\TableEntity $entity
     * @return array
     */
    protected function _resolveAttributes(\ZendService\WindowsAzure\Storage\TableEntity $entity)
    {
        $result = array();
     ...
     * @param  string $key
     * @return void
     * @throws \ZendCloud\DocumentService\Exception\InvalidArgumentException
     */
     ...
     *
     * @param  \ZendCloud\DocumentService\Document|array $document
     * @throws Exception\RuntimeException
     * @return void
     */
